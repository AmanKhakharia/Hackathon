...
def student_new_record():
    ...
    Label(screen4, text="", bg='#174873', width='80', height='18').place(x=0, y=127)
...
def student_records():
    ...
    Label(screen3, text="", bg='#174873', width='130', height='24').place(x=0, y=127)
...
def welcome_page(student_info):
    ...
    Message(screen2, text='" Some people dream of accomplishing great things. Others stay awake and make it happen. "\n\n - By Some Night Owl', width='120', font=("Helvetica", 10, 'bold', 'italic'), fg='white', bg='#174873', anchor = CENTER).place(x=10, y=100)
    #photo = PhotoImage(file="student.png") # opening left side image - Note: If image is in same folder then no need to mention the full path
    #label = Label(screen2, image=photo, text="") # attaching image to the label
    #label.place(x=60, y=405)
    ...
    Button(screen2, text='Enter your grades', width=20, font=("Open Sans", 13, 'bold'), bg='brown', fg='white', command=student_new_record).place(x=270, y=270)
...
def register():
    ...
    Label(screen1, text="", bg='#174873', width='100', height='20').place(x=45, y=120)
...
def main_screen():
    ...
    Label(screen, text="", bg='#174873',width='72', height='17').place(x=45, y=120) # blue background in middle of window
